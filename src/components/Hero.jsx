    ...
    >
      <Box
        sx={{
          ...
          inset: 0,
          zIndex: 0,
          backgroundImage: `linear-gradient(${theme.custom.border} 1px, transparent 1px), linear-gradient(90deg, ${theme.custom.border} 1px, transparent 1px)`,
      ...
      <Box sx={{ maxWidth: theme.custom.maxWidth, mx: 'auto', width: '100%', position: 'relative', zIndex: 1, pt: 10 }}>
        ...
        <Stack direction="row" spacing={4} flexWrap="wrap" useFlexGap sx={{ mt: 8 }}>
          {stats.map(([n, l]) => (
            <Box key={n}>
